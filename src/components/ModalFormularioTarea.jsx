...
const ModalFormularioTarea = () => {
    ...
    const {alerta, tarea, mostrarAlerta, modalFormularioTarea, handleModalTarea, submitTarea, editarTarea} = useProyectos();
    ...
    const handleSubmit = async e => {
      ...
      if(!tarea?._id) {
        await submitTarea({...registro, proyecto: id})
      } else {
        await editarTarea({...registro, proyecto: id, id:tarea._id})
      }
                            ...
                            <div className="sm:flex sm:items-start">
                                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                                    <Dialog.Title as="h3" className="text-lg leading-6 font-bold text-gray-900">
                                      {tarea?.nombre ? 'Editar Tarea' : 'Crear Tarea'}
                                    </Dialog.Title>
                                      ...
                                      >
                                        ...
                                        <div className=' mb-5'>
                                          ...
                                          <textarea
                                            ...
                                            className=' border w-full p-2 mt-2 h-20 placeholder-gray-400 rounded-lg'
                                        ...
                                        <div className=' mb-5'>
                                          ...
                                          <select 
                                            ...
                                            onChange={e => setRegistro({...registro, prioridad: e.target.value})}
                                        ...
                                        <input 
                                          ...
                                          p-3 uppercase font-bold cursor-pointer transition-colors rounded text-sm'
                                          value={tarea?.nombre ? 'Guardar Cambios' : 'Crear Tarea'}
                                        />
                                      </form>
                                </div>
                            </div>
